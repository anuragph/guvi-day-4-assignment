...
request.onload = function() {
  ...
  for(var country of data) {
    // Display flags using 'console.image' library.
    console.image(country['flag']) // Links not working. ERR_CONNECTION_RESET
  }
}
...
console.log(undeclared1) // undefined
console.log(undeclared2) // undefined
console.log(undeclared3) // undefined
console.log(undeclared4) // undefined
...
var lengthOfFoods = foods.length // 20
...
console.log(friends) // ['Munnabai', 'MaryJane', 'CaptianAmerica', 'Munnabai', 'Jeff', 'AAK chandran']
...
console.log(newFriends) // ['AAK chandran', 'CaptianAmerica', 'ET', 'Gabbar', 'Jeff', 'Jeff', 'Mari', 'MaryJane', 'Mass', 'Munnabai', 'Rajinikanth', 'Spiderman']
...
console.log(`First: ${firstItem}, Middle: ${middleItem}, Last: ${lastItem}`) // First: AAK chandran, Middle: Jeff, Last: Spiderman
...
console.log(friendsWithTitles) //  ['Mr. Donald', 'Mr. AAK chandran', 'Mr. CaptianAmerica', 'Mr. ET', 'Mr. Gabbar', 'Mr. Jeff', 'Mr. Jeff', 'Ms. Mari', 'Ms. MaryJane', 'Mr. Mass', 'Mr. Munnabai', 'Mr. Rajinikanth', 'Mr. Spiderman', 'Mr. Bob']
...
console.log(friendsWithA) // ['Donald', 'AAK chandran', 'CaptianAmerica', 'Gabbar', 'Mari', 'MaryJane', 'Mass', 'Munnabai', 'Rajinikanth', 'Spiderman']
...
console.log(`Average name length: ${avgNameLength}`) // Average name length: 6.785714285714286
...
console.log(friendsStartingWithM) // ['Mari', 'MaryJane', 'Mass', 'Munnabai']
...
console.log(`Name with max chars: ${longestName}`) // Name with max chars: CaptianAmerica
...
console.log(`Name with min chars: ${shortestName}`) // Name with min chars: ET
